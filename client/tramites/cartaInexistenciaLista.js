...
.controller("PrimerasComunionesListaCtrl", PrimerasComunionesListaCtrl);
 function PrimerasComunionesListaCtrl($scope, $meteor, $reactive, $state, toastr){
  ...
  this.helpers({
		arreglo : () => {
			return PrimerasComuniones.find({
